...
const PostStats = ({ post, userId }: PostStatsProps) => {
  ...
  // Store saved post information in localStorage
  useEffect(() => {
    localStorage.setItem("savedPosts", JSON.stringify(currentUser?.save || []));
  }, [currentUser?.save]);

  useEffect(() => {
    // Retrieve saved post information from localStorage on mount
